...
def sample_context():
    return [
        ...
        {
            "text": "Release 2.3 included UI changes to signup flow",
            "rank_score": 0.87
        }
    ]
...
def test_citation_extraction(reasoning, sample_context):
    ...
    if not answer["refused"] and answer.get("answer"):
        ...
        for citation in citations:
            assert any(context["text"] in citation or citation in context["text"] 
                      for context in sample_context) or citation == ""
